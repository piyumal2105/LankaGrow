  ...
  return (
    <>
      ...
      <motion.div
        ...
        className={clsx(
          "fixed left-0 top-0 bottom-0 w-80 bg-white border-r border-gray-200 z-30 lg:translate-x-0 lg:static lg:z-0",
      ...
      >
        ...
        <div className="p-4 border-t border-gray-200 space-y-2">
          ...
          <button
            onClick={logout}
            className="w-full sidebar-nav-item sidebar-nav-item-inactive text-left"
          >
